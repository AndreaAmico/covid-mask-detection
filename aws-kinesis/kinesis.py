...
# Configure your environment variabiles first
your_env_access_key_var = 'AWS_ACCESS_KEY' # client key
your_env_secret_key_var = 'AWS_SECRET_KEY' # secret key
your_stream_name = 'research-face-reco-mask'
your_region = 'eu-west-1'

def get_endpoint_boto():
    client = boto3.client('kinesisvideo',
            region_name=your_region,
            aws_access_key_id=os.getenv(your_env_access_key_var),
            aws_secret_access_key=os.getenv(your_env_secret_key_var)
        )
...
class gen_request_parameters:
    def __init__(self):
        self._data = ''
        if True:
            localfile = 'sample.mkv' # upload ok, max 20MB
